...
#'
#' @description Quantify the strength of the evidence provided by the data to a model/hypothesis according to the Bayes factor interpretation scale suggested by \insertCite{jeffreys1961;textual}{polya}.
#'
#' @param bf A numeric vector of non-negative values.
#'
#' @details Bayes factors are a summary of the evidence provided by the data to a model/hypothesis. \insertCite{jeffreys1961;textual}{polya} suggested the interpretation of Bayes factors in half-units on the base 10 logarithmic scale, as indicated in the following table:
#'
...
#'
#' @seealso
#' * \code{\link[polya]{bfactor_interpret_kr}} for an alternative interpretation scale.
#' * \code{\link[polya]{bfactor_log_interpret}} and \code{\link[polya]{bfactor_log_interpret_kr}} for the interpretation of the logarithms of Bayes factors.
#' * \code{\link[polya]{bfactor_to_prob}} to turn Bayes factors into posterior probabilities.
