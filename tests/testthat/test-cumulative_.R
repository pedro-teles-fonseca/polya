...
test_that("1 sample test 1", {
  expect_equal(
    cumulative_bfactor_multinomial(samples = list(austria_bl1), categories = 1:9, null_par = theta_benford(1), hyper_par = rep(1, 9)),
    bfactor_multinomial(x = austria_bl1, categories = 1:9, null_par = theta_benford(1), hyper_par = rep(1, 9)),
  )
})
...
test_that("1 sample test 1", {
  expect_equal(
    cumulative_bfactor_multinomial(samples = list(austria_bl1), categories = 1:9, null_par = theta_benford(1), hyper_par = rep(1, 9)),
    fbf_multinomial(x = austria_bl1, categories = 1:9, null_par = theta_benford(1), hyper_par = rep(1, 9), b = 0)
  )
})
...
test_that("2 samples", {
  expect_equal(
    cumulative_bfactor_multinomial(
      ...
      hyper_par = rep(1, 9)),
    c(
      bfactor_multinomial(x = austria_bl1, categories = 1:9, null_par = theta_benford(1), prior = "dirichlet", hyper_par = rep(1, 9)),
      bfactor_multinomial(x = finland_bl1, categories = 1:9, null_par = theta_benford(1), prior = "dirichlet", hyper_par = rep(1, 9))
      )
  )
})
